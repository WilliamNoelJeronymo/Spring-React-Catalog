...
public class ProductResourceTest {
	...
	void setUp() throws Exception {
		...
		when(service.uptdate(eq(existingId), any())).thenReturn(productDTO);
		when(service.uptdate(eq(nonExistingId), any())).thenThrow(ResourceNotFoundException.class);
	...
	@Test
	public void insertShoudReturnProductDTOCreated() throws Exception {
	...
	@Test
	public void findByIdShoudReturnProductWhenIdExisting() throws Exception {
